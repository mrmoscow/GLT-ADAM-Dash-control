...
def update_link_a01(n_clicks):
    if n_clicks is None:
        ...
        return RAD.check_ADAM('A01')

@the_app.callback(Output('a03-link-result','children'),Input('a03-link-check','n_clicks'))
def update_link_a03(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A03')

@the_app.callback(Output('a10-link-result','children'),Input('a10-link-check','n_clicks'))
def update_link_a10(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A10')

@the_app.callback(Output('a11-link-result','children'),Input('a11-link-check', 'n_clicks'))
def update_link_a11(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A11')

@the_app.callback(Output('a14-link-result','children'),Input('a14-link-check', 'n_clicks'))
def update_link_a14(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A14')

@the_app.callback(Output('a17-link-result','children'),Input('a17-link-check', 'n_clicks'))
def update_link_a17(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A17')

@the_app.callback(Output('a44v-link-result','children'),Input('a44v-link-check', 'n_clicks'))
def update_link_a44v(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A44_volt')

@the_app.callback(Output('a44r-link-result','children'),Input('a44r-link-check', 'n_clicks'))
def update_link_a44r(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A44_ReSl')

@the_app.callback(Output('a45v-link-result','children'),Input('a45v-link-check', 'n_clicks'))
def update_link_a45v(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A45_volt')

@the_app.callback(Output('a45r-link-result','children'),Input('a45r-link-check', 'n_clicks'))
def update_linkt_a45r(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    else:
        return RAD.check_ADAM('A45_ReSl')
