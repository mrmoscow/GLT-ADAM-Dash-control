...
try:
    print("All ADAM works, The receiver will set to ",rx)
    RAD.set_Rx(rx,tone)
    ...
    if args.nomirror:
        ...
        print("Now will moving the M3 mirrot to",mpos, "and watch sky")
        result1 = subprocess.run(["cpy3", ROT, mpos ,"sky"],capture_output=True,
